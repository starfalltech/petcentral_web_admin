...
class ColorsValue {
  ...
  static const Color black_search = Color(0xff58A7F0);
  static const Color yellow = Color(0xffFFB800);
  static const Color outside = Color(0xff3C3844);
  static const Color gray = Color(0xffEEECF1);
  static const Color gradSearch = Color(0xff3b5998);
  static const Color gray2 = Color(0xffF6F7FB);
  static const Color red = Color(0xffFF0000);
  static const Color borderGray = Color(0xffABABAB);
  static const Color primary = Color(0xff58A7F0);
}
